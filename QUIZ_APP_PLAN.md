...
Приложение для подготовки 10-летнего ребёнка к экзамену 11+ (UCS school, Лондон, январь 2027). Ребёнок из русскоязычной семьи, 4.5 года в UK. Основные проблемы: пропускает незнакомые слова, не проверяет ошибки, торопится, не пишет working out. Цель приложения — ежедневное 5-7 минутное повторение ключевых знаний через интервальный алгоритм.
